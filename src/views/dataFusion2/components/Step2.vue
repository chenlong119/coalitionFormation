    ...
    <div class="container">
      ...
      <el-row>
        <el-table :data="currentTaskList2" style="width: 100%" border class="table custom-table">
          ...
          <el-table-column prop="cooperationWillingness" :label="'合作意愿强度\n(0~100)'" width="150px" align="center"
                           :formatter="formatHundred"/>
<!--          <el-table-column prop="cooperationWillingness" width="150px" align="center">-->
<!--            <template slot="header">-->
<!--              <div style="text-align: center;">合作意愿强度</div>-->
            ...
            ? [] : {
              normal: {
                color: function (params) {
                  ...
                  const layerColors = ['#61a0a8', '#63b2ee', '#76da91', 'rgba(196,76,126,0.98)', 'rgba(196,76,126,0.98)'];
    ...
    tooltip: {
      ...
      formatter: function (params) {
        if (params.dataType === 'node') {
          ...
          if (layer === 1) {
            return "id: " + trueId + '<br/>' + "企业名称：" + name + '<br/>' + "市场份额：" + marketShare + '<br/>' + "市场增长率：" + marketIncrease + '<br/>' + "盈利率：" + profitability + '<br/>' + "科研投入比例：" + investRatio + '<br/>' + "产品线宽度：" + productWidth + '<br/>' + "产品线深度：" + productDepth + '<br/>' + "品牌知名度：" + brandAwareness;
          } else if (layer === 2) {
            return "id: " + trueId + '<br/>' + "企业名称：" + name + '<br/>' + "供应商数量：" + suppliersNum + '<br/>' + "库存周转率：" + turnover + '<br/>' + "准时交付率：" + deliveryRate + '<br/>' + "物流水平：" + tradeLevel;
          } else if (layer === 3) {
            return "id: " + trueId + '<br/>'  + "企业名称：" + name + '<br/>' + "合作意愿强度：" + cooperationWillingness + '<br/>' + "信誉分：" + reputation + '<br/>' + "参与合作数量：" + cooperationNum + '<br/>' + "合作成功率：" + cooperationSuccess + '<br/>' + "合作项目平均收益率：" + averageRoi;
          }
        }
...
.el-table th, .el-table td {
  //white-space: pre-wrap; /* 或者使用 pre-wrap 根据您的需求 */
  overflow: visible; /* 让内容可见 */
  text-overflow: clip; /* 移除省略号显示，以便完整显示文本 */
}

  ...
  <el-col>
    <div class="box-card">
      ...
      <el-table :data="rankData" class="el-table" stripe>
        <el-table-column type="index" width="120" label="排名" align="center">
        ...
        <el-table-column prop="companyName" label="企业群名称" width="150" align="center"></el-table-column>
        <el-table-column prop="companyScore" label="分数" align="center"></el-table-column>
      </el-table>
    </div>
  </el-col>
</template>
...
export default {
  ...
  methods: {
    ...
    async getRankList() {
      try {
        const response = await fetchCompanyRanking();
        console.log("Response:", response);
        if (response) {
          this.rankData = response;
          console.log("Data loaded:", this.rankData);
          this.$emit('update:rankData', this.rankData);
        } else {
